...
from vocabai import ai_client, tts_client, get_config, language_constants

class TestVocabAIFull(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_all_languages_tts(self):
        """
        ...
        self.assertEqual(len(missing_codes), 0, f"Missing TTS codes for: {', '.join(missing_codes)}")

    def test_generation_diverse_languages(self):
        ...
        for source, definition_lang, word, expected_base in diverse_cases:
